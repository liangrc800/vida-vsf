...
def main(runid):
    ...
    # args.path_model_save = "./saved_models/" + "forecasters/" + args.model_name + "/" + dataset_name + "/"
    import os
    ...
    for i in range(1, args.epochs+1):
        ...
        log = 'Runid: {:d} , Epoch: {:03d}, Train Loss: {:.4f}, Train RMSE: {:.4f}, Valid Loss: {:.4f}, Valid RMSE: {:.4f}, Training Time: {:.4f}/epoch'
...
if __name__ == "__main__":
    ...
    print("\n MAE = {:.4f} +- {:.4f} ; RMSE = {:.4f} +- {:.4f}".format( all_runs_avermae, all_runs_aver_stdmae, all_runs_avermse, all_runs_aver_stdrmse ))
